...
public class Event {
    ...
    static class C01701 implements OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            this.val$intent.putExtra("alarmOption", Event.alarmOption);
    ...
    public static void onAlarmOptionSelected(Builder builder, View dialogView, Marker marker) {
        ...
        builder.setPositiveButton("\uc644\ub8cc", new C01701((RadioGroup) dialogView.findViewById(C0177R.id.dialog_rg), (RadioButton) dialogView.findViewById(C0177R.id.dialog_1min), (RadioButton) dialogView.findViewById(C0177R.id.dialog_3min), (RadioButton) dialogView.findViewById(C0177R.id.dialog_5min), context, dialogView, new Intent(context, MyService.class), marker));
